...
# Covid-19 new cases by country (US, India, Brazil)
covid19cases<-read_csv("https://github.com/CSSEGISandData/COVID-19/raw/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_global.csv")
...
# Covid-19 new deaths by country (US, India, Brazil)
covid19deaths<-read_csv("https://github.com/CSSEGISandData/COVID-19/raw/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_global.csv")
covid19deaths %>%
  pivot_longer(-c('Province/State','Country/Region',Lat,Long),
               names_to= "date",
               values_to= "confirmed_n") %>%
  ...
  labs(x="Date",y="New Deaths",
       title= "New confirmed COVID-19 deaths in the United States, Brazil, and India (Feb 20-Mar 21)")
